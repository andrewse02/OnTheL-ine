...
public class IconAppleToastView : UIStackView {
    ...
    public init(image: UIImage, imageTint: UIColor? = defaultImageTint, title: String, subtitle: String? = nil, textColor: UIColor?) {
        ...
        if let subtitle = subtitle {
            ...
            subtitleLabel.textColor = Colors.lightDark
